  ...
  return (
    <>
      <div className=" mx-auto px-0 w-100">
            ...
            <div className="row dir">
              ...
              <div className="col-sm-6 center-xs mrgt16-xs text-dir">
                ...
                <div className="promotion-button">
                  <a
                    onClick={() =>
                      promotionInfo.current.scrollIntoView({
                        behavior: "smooth",
                        block: "start",
                        inline: "nearest",
                      })
                    }
                    className="btn btn-default bolder-title"
                  >
                    {t("promotion-competition.banner.competition_info_btn")}
                  </a>
                  <a
                    href="#"
                    className="btn btn-pink bolder-title"
                    style={{ margin: "0 16px" }}
                  >
                    {t("promotion-competition.banner.register_btn")}
                  </a>
                </div>
        ...
        <div className="container dir" ref={promotionInfo}>
          <div className="promotin-title text-dir">
            <h6>
              ...
              />
              <span>
                {t("promotion-competition.arthibition_holding_competition")}
              </span>
            </h6>
          ...
          <div className="promotion-body text-dir">
            <div className="row">
              <div className="col-sm-7">
                <p className="mrgt40">
                  این مسابقه رقابتی است با هدف فراهم کردن فرصتی برای به اشتراک
                  گذاشتن آثار متنوع هنری ایجاد شده با استفاده از ارتباطات
                  طرفداران در سراسر جهان برای الهام گرفتن از یکدیگر و کمک به
                  تجارب خلاقانه آن ها. در این مسابقه هیچ دسته بندی و موضوع خاصی
                  وجود ندارد. این جایزه عمدا این هدف را برای تشویق تخیل نگه
                  داشته است متقاضیان میبایست هنرمندانی انفرادی باشند نه گروهی.
                  ورود محدود به آثار هنری است که از طریق مسابقه یا نمایشگاه
                  دیگری (به استثنای نمایشگاه‌ شخصی یا صفحات رسانه‌های اجتماعی
                  شخصی هنرمند) قبلا در معرض نمایش عمومی قرار نگرفته‌اند. برای هر
                  نفر فقط یک قطعه اثر هنری ارسال می‌شود .آثار هنری شما باید با
                  استفاده از محصولات ایجاد شده باشد .هزینه‌ی ورودی وجود ندارد و
                  این مسابقه رایگان است
                </p>
                <h5 className="mrgt40">
                  {t("promotion-competition.condition")}
                </h5>
                <p>
                  برای همه در سراسر جهان باز است هیچ گونه محدودیتی برای ملیت،
                  سن، تجربه، محل اقامت و غیره وجود ندارد. کلیه متقاضیان .زیر ۱۳
                  سال نیاز به رضایت والدین یا سرپرست قانونی دارند
                </p>
                <h5 className="mrgt40">{t("promotion-competition.prize")}</h5>
                <p>
                  .این جایزه بزرگ شامل ۱۰ جایزه ۱ میلیون تومانی، دعوت از مراسم
                  اهدای جوایز در گالری آرتیبیشن می‌باشد .آخرین مهلت ثبت نام ۱۵
                  مرداد ۱۳۹۹ می‌باشد
                </p>
              </div>
              <div className="col-sm-5">
                <div className="promotion-detail">
                  ...
                  <ul>
                    ...
                    <li>
                      رونمایی از ۳۰ اثر برگزیده در نمایشگاه{" "}
                      <span className="bluestyle">گالری آرتیبیشن</span>
                    </li>
                  </ul>
                  <button className="btn btn-continue" type="button">
                    {t("promotion-competition.join_upload_btn")}
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="promotion-result">
            <h2 className="default-title text-dir">
              {t("promotion-competition.selected_artworks")}
            </h2>
            <div className="row dir">
                  ...
                  <div className="col-body">
                    ...
                    <div className="col-dimension">
                      <span className="col-dimension-title">
                        {t("promotion-competition.artwork.size")}
                      </span>
                    ...
                    <div className="col-price">
                      ...
                      <span className="col-price-unit">
                        {t("promotion-competition.artwork.price_unit")}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-xs-6">
                    <div className="form-group pull-dir-rev">
                      <select className="form-control" id="sel1">
                        <option>
                          {t("promotion-competition.last_update_select")}
                        </option>
                        <option>
                          {t("promotion-competition.sell_select")}
                        </option>
                        <option>
                          {t("promotion-competition.visite_select")}
                        </option>
                      </select>
                    </div>
                  </div>
