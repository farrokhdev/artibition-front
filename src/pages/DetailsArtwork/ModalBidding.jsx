    ...
    apiServices
      ...
      .then((res) => {
        if (res.data) {
          ...
          message.error({
            content: "برای ثبت قیمت پیشنهادی ابتدا باید عضو شوید",
            style: {
              marginTop: "10vh",
            },
          });
        ...
        <div className="modal-content px-5">
          ...
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">
              {t("artwork.modal_bidding_artwork.title")}
            </h5>
          </div>
          <div className="modal-body">
            <p className="text-center">
              {t("artwork.modal_bidding_artwork.subtitle")}
            </p>
                  ...
                  <div className="col">
                    <div className="d-flex w-100 ">
                      <div className="col text-dir px-0">
                        <span className="mx-0 mx-sm-2">
                          {numDiscriminant(offerValue)}
                        </span>
                        <span>{t("toman")}</span>
                      </div>
                    </div>
            ...
            <div className="col-sm-10 col-sm-offset-1">
              <div className="d-flex justify-content-center">
                <button
                  ...
                  onClick={onFinish}
                >
                  {t("artwork.modal_bidding_artwork.submit")}
                </button>
              </div>
            </div>
          </div>
