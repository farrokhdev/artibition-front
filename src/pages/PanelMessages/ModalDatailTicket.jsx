...
function ModalDatailTicket(props) {
  ...
  const handleReply = (values) => {
    ...
    apiServices
      .post(TICKET_REPLY(ticketDetail.id), payload)
      .then((res) => {
        setTimeout(() => {
          setVisibleDetailTicket(false);
        }, 500);
  ...
  return (
    <React.Fragment>
      <Modal
        ...
        footer={[]}
      >
        <Form className="" form={form} onFinish={handleReply}>
          <div className="modal-content px-5" style={{ direction: "rtl" }}>
            ...
            <div className="modal-header">
              <div className="col">
                <h5 className="modal-title " id="exampleModalLabel">
                  {t("content-panel-messages.tabs.members.title_modal")}
                </h5>

                <div className="d-flex  ticket-subject  justify-custom">
                  <div className="col w-100">
                    <span className="font17 graycolor text-dir">
                      {t("content-panel-messages.tabs.members.subject")}
                    </span>
                    <span className="bolder-title text-dir">
                      {ticketDetail?.title}
                    </span>
                  </div>
                </div>
            ...
            <div className="modal-body">
                      ...
                      <div className="col  px-0">
                        <div className="d-flex ">
                          <div className="d-block w-100">
                            <div className="col  w-100">
                              <div className="d-flex w-100">
                                <h4 className="gallery-artist-name text-dir  w-100">
                                  {Language === "fa-IR"
                                    ? ticketDetail?.owner?.translations?.fa
                                        ?.first_name + " "
                                    : ticketDetail?.owner?.translations?.en
                                        ?.first_name + " "}
                                  {Language === "fa-IR"
                                    ? ticketDetail?.owner?.translations?.fa
                                        ?.last_name
                            ...
                            <div className="col ">
                              <div className="d-flex">
                                <span className=" graycolor text-dir w-100">
                      ...
                      <div className="col ">
                        <div className="d-flex justify-custom">
                          <div className="td-right">
                            <span className="pull-dir graycolor px-1">
                              {" "}
                              {ticketDetail
                                ? moment(ticketDetail?.creation_date)
                                    .locale("fa")
                                    .format("hh:mm")
                                : ""}
                            </span>
              ...
              {ticketDetail?.reply?.length
                ? ticketDetail.reply.reverse().map((item, key) => {
                    console.log(item);
                    return (
                      <div className="ticket-modal-block">
                        <div className="d-flex box-dir-reverse">
              ...
              {ticketDetail?.state === "close" ? (
                <h4 className="text-center text-muted">
                  به دلیل بسته بودن تیکت امکان ارسال پیام وجود ندارد.
                </h4>
                  ...
                  <div className="form-group w-100">
                    ...
                    >
                      <Input
                        ...
                        placeholder={t(
                          "content-panel-messages.tabs.members.palaceholder_message"
                        )}
                      />
                    </Form.Item>
                    ...
                    <button htmlType="submit" className="btn-blue">
                      <img
                        ...
                        height="34"
                        alt=""
                        className="center-block send-icon-message"
                      />
                    </button>
                  </div>
                </div>
