...
export const NewArtworkFromFavoritedArtist = () => {
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          ...
          >
آثار جدید از هنرمند محبوب شما
          </h1>
          <p class="maxw400" style={{ maxWidth: "400px", margin: "0 auto" }}>
          به تازگی آثار جدیدی از این هنرمند در سایت اضافه شده است با کلیک کردن دکمه زیر این آثار را مشاهده نمایید
          </p>
          <a
            href="#"
