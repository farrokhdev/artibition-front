...
export const UpgradeToArtistProfile = () => {
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          <img
            src="//api.artibition.gallery/static/img/verify_pending.svg"
            alt=""
          ...
          >
            ثبت درخواست عضویت هنرمند  
          </h1>
          <p
            className="maxw400-email"
            style={{ maxWidth: "400px", margin: "0 auto", lineHeight: "1.5" }}
          >
 ضمن تشکر بابت عضویت شما به عنوان هنرمند در سایت آرتیبیشن به زودی درخواست شما بررسی و نتیجه از طریق ایمیل و سایت به شما اطلاع رسانی می‌شود
          </p>
          <a
            href="#"
