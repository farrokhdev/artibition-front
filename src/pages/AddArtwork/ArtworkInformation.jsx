...
function ArtworkInformation({ next, prev }) {
  ...
  const onFinish = (values) => {
    ...
    if (uploadList.length) {
      ...
      message.error({
        content: "آپلود تصویر اجباری می باشد",
        style: {
          marginTop: "10vh",
        },
      });
  ...
  return (
    <>
      ...
      <h3 className="info-title mrgt64 require text-dir">
        {t("content-panel-add-artwork.upload.title")}
      </h3>
                ...
                <div className="public-group en">
                  ...
                  >
                    <Input
                      ...
                      placeholder={t(
                        "content-panel-add-artwork.art_info.artwork_titles"
                      )}
                    />
                  </Form.Item>
                </div>
            ...
            {!(getUserRole() === "gallery") && !searchParams.get("artist_id") && (
              <div className="d-block d-sm-flex box-dir-reverse w-100">
                ...
                >
                  <div className="public-group">
                    {getUserRole() === "artist" ? (
                      <Form.Item className="w-100 " name="artist_name">
                        {console.log("artist")}
                        <Input
                          type="text"
                          id="info-201"
                    ...
                    <div className="public-group">
                      ...
                      >
                        <Input
                          ...
                          className="d-flex box-dir-reverse form-control input-public en-lang border-0 px-2"
                          placeholder={t(
                            "content-panel-add-artwork.art_info.height"
                          )}
                        />
                      </Form.Item>
                    </div>
                ...
                <div className="public-group">
                  ...
                  >
                    <Input
                      ...
                      className="d-flex box-dir-reverse form-control input-public en-lang border-0 px-2"
                      placeholder={t(
                        "content-panel-add-artwork.art_info.weight"
                      )}
                    />
                  </Form.Item>
                </div>
                ...
                <div className="public-group">
                  ...
                  >
                    <Input
                      ...
                      className="d-flex box-dir-reverse form-control input-public en-lang border-0 px-2"
                      placeholder={t(
                        "content-panel-add-artwork.art_info.tag_fa"
                      )}
                    />
                  </Form.Item>
                  <span className="input-help text-dir">
                    {t("content-panel-add-artwork.art_info.text_tag_fa")}{" "}
                  </span>
                </div>
              </div>
              <div
                ...
                <div className="public-group">
                  ...
                  >
                    ...
                    <Input
                      ...
                      className="d-flex box-dir-reverse form-control input-public en-lang border-0 px-2"
                      placeholder={t(
                        "content-panel-add-artwork.art_info.tag_en"
                      )}
                    />
                  </Form.Item>
                  <span className="input-help text-dir w-100">
                    {t("content-panel-add-artwork.art_info.text_tag_en")}
                  </span>
                </div>
              </div>
            </div>
