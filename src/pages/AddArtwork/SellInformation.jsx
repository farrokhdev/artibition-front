            ...
            <div className="col-sm-12">
              <label className="d-flex box-dir-reverse lable-checkbox public-group text-dir">
                <Form.Item name="view_only" valuePropName="checked" noStyle>
                  <Checkbox
                    type="checkbox"
                    checked={isValidEdition}
                    onChange={(e) => setIsValidEdition(e.target.checked)}
                  ></Checkbox>
                </Form.Item>
                <span className="mx-2">
                ...
                <>
                  <label className="d-flex box-dir-reverse lable-checkbox public-group text-dir pr-0">
                    <Form.Item name="remember" valuePropName="checked" noStyle>
                      <Checkbox
                        type="checkbox"
                        checked={isValidSaleInformation}
                        onChange={(e) =>
                          setIsValidSaleInformation(e.target.checked)
                        }
                      ></Checkbox>
                    </Form.Item>
                    <span className="mx-2">
                      {t("content-panel-add-artwork.art_info.multi_edition")}
                    </span>
                  </label>
