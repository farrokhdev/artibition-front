                                ...
                                <div class="row-galleryinfo d-flex">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="gallery-daterow">
                                            ...
                                            <span class="gallery-datenum persian-num m-0">{timeToStr(onPerforming && onPerforming[0]?.start_date[`${onPerforming[0]?.type === 'virtual_real' ? 'virtual' : onPerforming[0]?.type}_start_date`], "jYYYY/jMM/jDD")}</span>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="gallery-daterow">
                                            <span class="gallery-date pull-dir">پایان</span>
                                            <span class="gallery-datenum persian-num m-0">{timeToStr(onPerforming && onPerforming[0]?.end_date[`${onPerforming[0]?.type === 'virtual_real' ? 'virtual' : onPerforming[0]?.type}_end_date`], "jYYYY/jMM/jDD")}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
