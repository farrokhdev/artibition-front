...
function Exhibition({ id, galleryExhibition }) {
    ...
    return (
        <div id="gallery2" className="tab-pane fade in active">
                                ...
                                <div class="row-galleryinfo d-flex">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="gallery-daterow">
                                            ...
                                            <span class="gallery-datenum persian-num m-0">{timeToStr(item.start_date[`${item.type === 'virtual_real' ? 'virtual' : item.type}_start_date`], "jYYYY/jMM/jDD")}</span>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="gallery-daterow">
                                            <span class="gallery-date pull-dir">پایان</span>
                                            <span class="gallery-datenum persian-num m-0">{timeToStr(item.end_date[`${item.type === 'virtual_real' ? 'virtual' : item.type}_end_date`], "jYYYY/jMM/jDD")}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {expired.length > 0 &&
                <div className="public-header">
                    <h2 className="default-title text-dir">نمایشگاه‌های پیشین</h2>
                </div>
            }
