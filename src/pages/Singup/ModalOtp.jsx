...
function ModalOtp(props) {
  ...
  const { visibleOtpModal, setVisibleOtpModal, resendOTP } = props;
  ...
  const onFinish = (values) => {
    ...
    APIService.post(VERIFY, values).then((res) => {
      if (res.data) {
              ...
              <div className="col px-5">
                ...
                <Form className="" form={form} onFinish={onFinish}>
                  ...
                  <div className="d-flex justify-content-center mt-5">
                    <button htmlType="submit" className="btn-confirm-phone">
                      {t("text-btn-confirm-mobile-number")}
                    </button>
                  </div>
                </Form>
              </div>
