...
function ModalAddAddress({ setVisibleAddAddress, visibleAddAddress, locations }) {
    ...
    const onFinish = (values) => {
        ...
        if (editingLocation?.id) {
            apiServices.patch(EDIT_ADDRESSES(editingLocation?.id), payload)
                .then(res => {
                    if (res.data) {

                        handleClose();
                        message.success({ content: "اطلاعات با موفقیت ویرایش شد", style: { marginTop: '10vh' } })

                    }
                })
        } else {

            apiServices.post(ADDRESSES, payload)
                .then(res => {
                    if (res.data) {
                        setVisibleAddAddress(false)
                ...
                >
                    <div class="modal-content mt-5">
                        <div class="modal-header">
                            {editingLocation?.id ?
                            <h5 class="modal-title mx-auto" id="exampleModalLabel">ویرایش آدرس </h5>
                        ...
                        <div class="modal-body">
                            <div class="enter-address">
                                ...
                                <div class="col-sm-6">
                                    <Form.Item className="public-group flex-start"
                                        name="state"
                                        rules={[
                                            {
                                                required: true,
                                        ...
                                        <Input className="form-control input-public " placeholder="استان" />
                                ...
                                <div class="col-sm-6">
                                    <Form.Item className="public-group flex-start"
                                        ...
                                        <Input className="form-control input-public " placeholder="کشور" />
                                ...
                                <div class="col-sm-6">
                                    ...
                                    >
                                        ...
                                        <Input type="number" className="form-control input-public " placeholder="کد پستی" />
                                ...
                                <div class="col-sm-6">
                                    <Form.Item className="public-group flex-start"
                                        ...
                                        <Input className="form-control input-public " placeholder="شهر" />
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <Form.Item className="public-group flex-start"
                                        ...
                                        <Input className="form-control input-public " placeholder="آدرس" />
                                    </Form.Item>
                        ...
                        <div class="modal-footer">
                            <button htmlType="submit" class="btn btn-black">ثبت و تأیید آدرس</button>
                        </div>
                    </div>
