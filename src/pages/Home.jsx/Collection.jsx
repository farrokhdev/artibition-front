...
export default function Collection() {
  ...
  const content = (
    <div className="popover-content">
      <p>
        با ایجاد کالکشن شما می‌توانید آثار مورد علاقه خود را با آن اضافه و آن‌ها
        را طبقه‌بندی نمایید
      </p>
      <a className="popover-btn" href="#" type="button">
        ایجاد کالکشن
      </a>
    </div>
  );
        ...
        <div className="public-header d-flex">
          <div className="col-6 col-md-8 ">
            <div className="d-flex">
              <h2 className="default-title pull-right px-4 ">
                {t("collection-artworks-home.title")}
              </h2>
              <div className="popover-collection">
                <Popover
                  ...
                  content={content}
                  title="کالکشن آثار"
                  overlayInnerStyle={{ paddingBottom: "30px" }}
                >
                  <a
                    title="کالکشن آثار"
                    data-toggle="popover"
          ...
          <div className="col-6 col-md-4 ">
            <div
              ...
              onClick={() => navigate("/site/collections-list")}
            >
              {t("collection-all")}
            </div>
          </div>
                  ...
                  <Link to="/site/collections-list" className="cols">
                    <div className="col-img mx-4">
                      <div className=" collection-firstrow m-0">
                        <img
                          src={item?.products[0]?.medias[0]?.exact_url}
                          width="280"
                          height="280"
                        ...
                        <div className="d-flex collection-secondrow  px-0">
                          {item.products[1] && (
                            <div className="col px-0  mt-2">
                              <img
                                src={item?.products[1]?.medias[0]?.exact_url}
                                width="280"
                                height="280"
                          ...
                          {item?.products[2] && (
                            <div className="col px-0 mr-2 mt-2">
                              <img
                                src={item?.products[2]?.medias[0]?.exact_url}
                                width="280"
                                height="280"
                                className="img-responsive clolection-image w-100"
                              />
