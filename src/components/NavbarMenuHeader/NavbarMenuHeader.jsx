                                            ...
                                            <div className="row">
                                                <div className="col-md-7 col-sm-6">
                                                    <ul className="vertical-nav">
                                                        ...
                                                        >
                                                            <Link to="/site/artworks">{t("nav-submenu.artworks.artField.all")}</Link></li>
                            ...
                            <div className="row ">
                                <div className="col-sm-3">
                                    <ul className="nav nav-tabs">
                                        ...
                                        ><Link to="/site/all-galleris-list">{t("galleries")}</Link></li>
                                    ...
                                    <div className="tab-content">
                                        <div id="nav11" className="tab-pane fade in active">
                                            <div className="row">
                                                <div className="col-md-7 col-sm-6">
                                                    <ul className="vertical-nav">
                                                        <li><Link to="/site/artists">{t("nav-submenu.showroom.category.all")}</Link></li>
