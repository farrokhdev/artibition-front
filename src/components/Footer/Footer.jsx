                        ...
                        <div className="row ">
                            ...
                            <div className="col-md-4 col-xs-3">
                                <div className="footer-nav text-dir">
                                    ...
                                    <ul className="footer-nav-body">
                                        <li><Link to="/site/content/copy-right">{t("footer.terms-of-use.copyright")}</Link></li>
                                        <li><Link to="/site/content/terms-and-conditional">{t("footer.terms-of-use.terms-and-conditional")}</Link></li>
                                        <li><Link to="/site/content/privacy">{t("footer.terms-of-use.policy")}</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-4 col-xs-4">
                                <div className="footer-nav text-dir">
                                    ...
                                    <ul className="footer-nav-body">
                                        ...
                                        <li><Link to="/site/content/collabrators">{t("footer.artibition.collabrators")}</Link></li>
