                ...
                <div className="col-md-4 col-sm-5 col-lg-5 hidden-xs">
                    <div className="search-container dropdown">
                        <input
                            ...
                            onChange={(t) => setParams((state) => ({...state, search: t.target.value}))}
                        />
                    ...
                    <div className="autocomplete" style={visibleResults ? {display: "unset"} : {display: "none"}}>
                            ...
                            {searchResult.map((item, key) =>
                                <li key={key}>
                                    <a href={strToLink(item.type_result, item.id)}>
                                        {
                                            i18n.language === "fa-IR" ?
                                                item.title[0].language_code === "fa" ? item.title[0].title : item.title[1].title :
                                                item.title[0].language_code === "en" ? item.title[0].title : item.title[1].title
                                        }
                                    </a>
                                </li>
                            )}
                        ...
                        <div className="predict-cat">
                            ...
                            <ul>
                                <li>
                                    <a onClick={() => setParams((state) => ({...state, object: "artist"}))}>هنرمند</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a onClick={() => setParams((state) => ({...state, object: ""}))}>حذف فیلتر</a>
                                </li>
                            </ul>
                        </div>
                    </div>
