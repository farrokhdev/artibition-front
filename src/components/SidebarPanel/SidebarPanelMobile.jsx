...
function SidebarPanelMobile(props) {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText(
      `با دعوت دوستان خود از آرتیبیشن حمایت نمایید\n\n` +
  ...
  return (
    <div className="sidebar_mobile active ">
      <div className="inner-sidebar">
          ...
          <div className="sidebar-personal-info text-dir">
            ...
            {getUserRole() !== "gallery" ? (
              <div className="sidebar-mobile">
                <span className="persian-num pull-dir">
        ...
        <div className="d-block mt-5">
          <ul className="text-dir">
            {getUserRole() === "gallery" && (
              <>
                <li className="sidebar-icon" id="home">
                  <Link to="/panel/dashboard">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-dashboard")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="manage-artworks">
                  <Link to="/panel/art-management">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-art-management")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="financial">
                  <Link to="/panel/orders">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-orders")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="content">
                  <Link to="/panel/contents">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-content")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="mypurchase">
                  <Link to="/panel/bidding-price">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.biding-price")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="my-albums">
                  <Link to="/panel/exhibitions">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-exhibitions")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon  my-4" id="artists">
                  <Link to="/panel/artists">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-artists")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="gallery">
                  <Link to={"/panel/galleries"}>
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-my-galleries")}
                    </span>
                  </Link>
                </li>
              </>
            ...
            {getUserRole() === "artist" && (
              <>
                ...
                <li className="sidebar-icon my-4" id="mypurchase">
                  <Link to="/panel/purchases">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-mypurchases")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="financial">
                ...
                <li className="sidebar-icon my-4" id="wallet">
                  <Link to="/panel/wallet">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-wallet")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="my-albums">
                  <Link to="/panel/my-albums">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-my-albums")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="liked">
                  <Link to="/panel/favorites">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-favorits")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4 " id="messages">
                  <Link to="/panel/messages">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-messages")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="content">
                ...
                <li className="sidebar-icon " id="profile">
                  <Link to="/panel/profile">
                    <span className="sidebar-nav-margin">
                      {t("drawer-panel.nav-profile")}
                    </span>
                  </Link>
                </li>
                <li className="sidebar-icon my-4" id="gallery">
        ...
        <div className=" justify-content-end ">
          <button
            type="button"
            className="d-flex btn-outline-pink box-dir-reverse dir"
