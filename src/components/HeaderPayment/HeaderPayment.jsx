        ...
        <div className="default-header basket-header">
            <div className="row dir">
                <div className="col-sm-8 col-sm-offset-2">
                    ...
                    <div className="clearfix hidden-xs"></div>
                    <ul className="basket-nav">
                        <li className="active"><a href="#">{t("header-panel.shopping_guid")}<span className="hidden-xs">{t("header-panel.from_site")}</span></a></li>
                        <li><a href="#">{t("header-panel.faq")}</a></li>
                        <li className="hidden-xs">{t("header-panel.contact_us")}<span className="persian-num">{t("header-panel.phone_number")}</span></li>
                    </ul>
                </div>
            </div>
        </div>
